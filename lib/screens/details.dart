        ...
        children: <Widget>[
          ListView(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10.0),
              Text(
                "Merupakan salah satu lapangan futsal yang berada di Kabupaten Indramayu. "
                "Tempat ini menyediakan lapangan dengan standar mengukuti aturan futsal rules, "
                "mulai dari garis lapangan, "
                "luas lapangan futsal dan lainnya. ",
                style: TextStyle(
                  fontSize: 15.0,
                  color: Colors.grey,
                  fontWeight: FontWeight.w600,
